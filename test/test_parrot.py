from Parrot_refactoring_Kata.parrot import AfricanParrot, EuropeanParrot, NorwegianBlueParrot, Parrot, ParrotType


def test_speed_of_european_parrot():
    parrot = EuropeanParrot( 0, 0, False, 0)
...
def test_speed_of_african_parrot_with_one_coconut():
    parrot = AfricanParrot(0, 1, 0,False)
...
def test_cry_norwegian_blue_parrot_no_voltage():
    parrot = NorwegianBlueParrot( 0,0, 0, False)
    assert parrot.cry() == "..."